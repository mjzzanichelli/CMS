var $$ = (
    function(){
        ...
        var getSelection = function(selector){
            selector = (getType(selector)=="array" ? selector : [selector]);
            return selector;
        };
        ...
        var setElementMethods = function(self){
            var _methods = {
                ...
                , parent: function(){
                    return self.elements[0].parentNode;
                }
                
                , children: function(){
                    return self.sibling(self.elements[0].firstChild);
                }
