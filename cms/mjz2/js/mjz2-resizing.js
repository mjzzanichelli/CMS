var $$resizable = function(){
    ...
    , _setResizableNorth = function(){
        ...
        _self.install(_name+"dragnorth",$$draggable,{"block-x":true,"handler":function(){
                ...
                , i = _subs.length
                ;
                while(i--) if ($$.hasClass(_subs[i],"mjz-handler") && $$.hasClass(_subs[i],"resizable-n")) break;
                return _subs[i];
            }
        });
        ...
        _self.on(_name+"dragnorthmove",function(e,obj){
            ...
            if (_resizer["dragger"]){
                ...
                _resizer["dragger"]["offset"] = $$.getOffset(_resizer["dragger"]["element"]);
                ...
                } else $$.setStyle(_resizer["dragger"]["element"],{"height":_height.toString()+"px"});
            } else $$.setStyle(this,{"height":_height.toString()+"px"});
        });
    ...
    , _setResizableSouth = function(){
        ...
        _self.install(_name+"dragsouth",$$draggable,{"block-x":true,"handler":function(){
                ...
                , i = _subs.length
                ;
                while(i--) if ($$.hasClass(_subs[i],"mjz-handler") && $$.hasClass(_subs[i],"resizable-s")) break;
                return _subs[i];
            }
        });
    ...
    , _setResizableEast = function(){
        ...
        _self.install(_name+"drageast",$$draggable,{"block-y":true,"handler":function(){
                ...
                , i = _subs.length
                ;
                while(i--) if ($$.hasClass(_subs[i],"mjz-handler") && $$.hasClass(_subs[i],"resizable-e")) break;
                return _subs[i];
            }
        });
    ...
    , _setResizableWest = function(){
        ...
        _self.install(_name+"dragwest",$$draggable,{"block-y":true,"handler":function(){
                ...
                , i = _subs.length
                ;
                while(i--) if ($$.hasClass(_subs[i],"mjz-handler") && $$.hasClass(_subs[i],"resizable-w")) break;
                return _subs[i];
            }
        });
        ...
        _self.on(_name+"dragwestmove",function(e,obj){
            ...
            if (_resizer["dragger"]){
                ...
                if (_resizer["dragger"]["offset"][0]<=_resizer["container"]["offset"][0]){
                    ...
                    $$.setStyle(_resizer["dragger"]["element"],_resizer["dragger"]["style"]);
                } else $$.setStyle(_resizer["dragger"]["element"],{"width":_width.toString()+"px"});
            } else $$.setStyle(this,{"width":_width.toString()+"px"});
        });
    ...
    , _setResizableNorthEast = function(){
        ...
        _self.install(_name+"dragnortheast",$$draggable,{"handler":function(){
                ...
                , i = _subs.length
                ;
                while(i--) if ($$.hasClass(_subs[i],"mjz-handler") && $$.hasClass(_subs[i],"resizable-ne")) break;
                return _subs[i];
            }
        });
    ...
    , _setResizableNorthWest = function(){
        ...
        _self.install(_name+"dragnorthwest",$$draggable,{"handler":function(){
                ...
                , i = _subs.length
                ;
                while(i--) if ($$.hasClass(_subs[i],"mjz-handler") && $$.hasClass(_subs[i],"resizable-nw")) break;
                return _subs[i];
            }
        });
        ...
        _self.on(_name+"dragnorthwestmove",function(e,obj){
            ...
            if (_resizer["dragger"]){
                ...
                if (_resizer["dragger"]["offset"][1]<=_resizer["container"]["offset"][1]){
                    ...
                    $$.setStyle(_resizer["dragger"]["element"],{"top":_resizer["dragger"]["style"]["top"],"height":_resizer["dragger"]["style"]["height"]});
                } else $$.setStyle(_resizer["dragger"]["element"],{"height":_height.toString()+"px"});
                //Limiting WEST to container
                if (_resizer["dragger"]["offset"][0]<=_resizer["container"]["offset"][0]){
                    ...
                    $$.setStyle(_resizer["dragger"]["element"],{"left":_resizer["dragger"]["style"]["left"],"width":_resizer["dragger"]["style"]["width"]});
                } else $$.setStyle(_resizer["dragger"]["element"],{"width":_width.toString()+"px"});
            } else $$.setStyle(this,{"height":_height.toString()+"px","width":_width.toString()+"px"});
        });
    ...
    , _setResizableSouthWest = function(){
        ...
        _self.install(_name+"dragsouthwest",$$draggable,{"handler":function(){
                ...
                , i = _subs.length
                ;
                while(i--) if ($$.hasClass(_subs[i],"mjz-handler") && $$.hasClass(_subs[i],"resizable-sw")) break;
                return _subs[i];
            }
        });
        ...
        _self.on(_name+"dragsouthwestmove",function(e,obj){
            ...
            if (_resizer["container"]){
                _resizer["dragger"]={
                    "element": this
                    , "style": $$.getStyle(this,["height","left"])
                };
            }
    ...
    , _setResizable = function(){
        ...
        , _element_position = $$.getPosition(_self.elements[0])
        , _style = {
            "position": "absolute"
            , "margin-left": "0"
            , "margin-top": "0"
